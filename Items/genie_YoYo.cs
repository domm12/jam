...
{
    public class genie_YoYo : ModItem    //make sure the sprite file is named like the class name (CustomYoyo)
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Genie YoYo");
            Tooltip.SetDefault("Has a Genie trappted inside");
        }
        public override void SetDefaults()
        {
            ...
            item.value = Item.buyPrice(0, 20, 0, 0); // How much the item is worth, in copper coins, when you sell it to a merchant. It costs 1/5th of this to buy it back from them. An easy way to remember the value is platinum, gold, silver, copper or PPGGSSCC (so this item price is 10gold)
            ...
            item.shoot = mod.ProjectileType("genie_YoYo_projectile"); //This defines what type of projectile this weapon will shot            
